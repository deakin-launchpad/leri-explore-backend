...
var sendError = function (data) {
  ...
  if (typeof data == 'object' && data.hasOwnProperty('statusCode')) {
    var errorToSend = new Boom(data.customMessage, { statusCode: data.statusCode, error: data.error }) // Undefined keys won't be added :)
